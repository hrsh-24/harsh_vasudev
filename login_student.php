        ...
        if (
            ...
            if($numrows == 1){
                while ($row = mysqli_fetch_array($result)) {
                    $login_username = $row['student_name'];
                    $login_email = $row['student_email'];
                    $login_password = $row['student_password'];
                    $login_role = $row['student_role'];
                }
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        <div class="text-center">
                            ...
                            <div class="panel-body">
                                <form id="login-form" action="login_student.php" role="form" autocomplete="off" class="form " method="post">

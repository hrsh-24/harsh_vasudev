...
include "includes/teacher_navigation.php";
...
if (ifItIsMethod('post')) {
   if (isset($_POST['email'])) {
      ...
      if (email_exists($email)) {
         if ($stmt = mysqli_prepare($connection, " UPDATE teachers SET token='{$token}' WHERE teacher_email = ?")); {
...
if (isset($_POST["submit"])) {
   ...
   $sel_query = "SELECT * FROM teachers WHERE teacher_email='$email'";
   ...
   if ($row) {
      ...
      $body    = "Hi , $teacher_name. Click here to reset your password http://localhost/Squadfree/reset_password.php?token=$token ";
      ...
      echo ("<SCRIPT LANGUAGE='JavaScript'>
         ...
         window.location.href='changepassteacher.php';
         </SCRIPT>");
   }
}
